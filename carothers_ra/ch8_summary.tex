...
\begin{corollary}{8.21}
    Let $\lvert \lvert \cdot \rvert \rvert_1, \lvert \lvert \cdot \rvert \rvert_2$ be any two norms on a vector space $V$.
    Then, $\lvert \lvert \cdot \rvert \rvert_1, \lvert \lvert \cdot \rvert \rvert_2$ are equivalent if and only if there are two constants $0 < c, C < \infty$ such that $c \lvert \lvert x \rvert \rvert_1 \leq \lvert \lvert x \rvert \rvert_2 \leq C \lvert \lvert x \rvert \rvert_2$ for every $x \in V$.
    In other words, norms are equivalent \textbf{iff} they are strongly equivalent.
\end{corollary}
...
\begin{corollary}{8.23}
    Let $V, W$ be normed vector spaces with $V$ finite-dimensional.
    Then, every linear map $T: V \rightarrow W$ is continuous.
\end{corollary}

\begin{corollary}{8.24}
...
\begin{corollary}{8.26}
    A finite-dimensional linear subspace of any normed vector space is always closed.
\end{corollary}