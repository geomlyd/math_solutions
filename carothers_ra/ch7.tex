...
\begin{solution}
    ...
    (b) Consider the function $f(x) = \frac{1}{x}$ and the complete metric space $M = [1 + \epsilon, \infty)$ for some $\epsilon > 0$.
    Notice, first, that the equation $f(x) = x \implies 1 = x^2$ only has two solutions, $x = 1, x = -1$, neither of which is in $M$.
    Furthermore, for any $x \geq 1 + \epsilon$ we have $\frac{1}{1 + \epsilon} \geq \frac{1}{x}$
    Therefore $f: M \rightarrow M$ has no fixed points.
\end{solution}