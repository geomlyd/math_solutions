...
\begin{solution}
    ...
    In the non-degenerate case, because $[a, b]$ is compact, we can apply Corollary 8.5 to obtain that $f$ is bounded on $[a, b]$ and attains its maximum and minimum values, $M, m$ respectively.
\end{solution}
