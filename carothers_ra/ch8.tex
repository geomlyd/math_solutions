...
\begin{solution}
    ...
    $\impliedby$: Suppose now that $\sum_{n=1}^{\infty} c_n^2 < \infty$.
    More specifically, this implies that $c_n \rightarrow 0$.
    Let $((x_n)_k)$ be any sequence (of sequences) in $S$.
    To show that $S$ is compact in $l_2$, it suffices, by Theorem 8.2, to show that $((x_n)_k)$ contains a subsequence that converges to a point in $S$.
    We note, first, that $\sum_{n=1}^{\infty} c_n^2 < \infty$, which means that 
